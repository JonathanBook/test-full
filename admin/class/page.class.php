...
class page{
	...
	private function build_header($titre){
		...
		if(isset($_SESSION[USERSESSION]['user']) && !empty($_SESSION[USERSESSION]['user'])){
            ...
            $this->header.= '        						</td>';
            $this->header.= '        						<td>';
            $this->header.= '        							<a href="index.php?to=listing_menu" class="lien_menu">Lister les Menu</a>';
            $this->header.= '        						</td>';
            $this->header.= '        					</tr>';
            $this->header.= '        					<tr style="height: 20px;">';
            $this->header.= '        						<td style="width: 20px;">';
            ...
            $this->header.= '        						</td>';
            $this->header.= '        						<td>';
            $this->header.= '        							<a href="index.php?to=listing_article" class="lien_article">Lister les Articles</a>';
            $this->header.= '        						</td>';
            $this->header.= '        					</tr>';
            $this->header.= '        					<tr style="height: 20px;">';
            $this->header.= '        						<td style="width: 20px;">';
            ...
            $this->header.= '        						</td>';
            $this->header.= '        						<td>';
            $this->header.= '        							<a href="index.php?to=article" class="lien_menu">Crée un nouvelle Article</a>';
            $this->header.= '        						</td>';
            $this->header.= '        					</tr>';
            $this->header.= '        				</table>';
            $this->header.= '        			</div>';
